    ...
    return (
        <div>
            <main>
                ...
                <WebAnnoucement
                    title="საიტის განახლება 2.3"
                    description="1. ანგარიშის შექმნა 2. პროფილის გვერდები 3. მოწონების ფუნქციონალი 4. სტატიების გამოქვეყნება და რედაქტირება 5. მოწონების ისტორია 6. ადმინის გვერდი"
                />
