    ...
    return (
        <div>
            <main>
                ...
                <WebAnnoucement
                    title="საიტის განახლება 2.0"
                    description="შესაძლებელია ანგარიშის შექმნა და მოწონების ფუნქციონალის გამოყენება, ასევე სტატიების თქვენით დადება/რედაქტირება. შეგიძლიათ ნახოთ მოწონებული სტატიების ისტორია."
                />
